...
export const services: Service[] = [
  {
    ...
    description:
      'We run your Instagram, TikTok, and YouTube so you can focus on what you do. Consistent content, real growth, zero guesswork.',
    bullets: [
  ...
  },
  {
    ...
    description:
      'Cinematic event coverage, artist visuals, and high-energy edits built for the scroll. We make content that stops thumbs.',
    bullets: [
